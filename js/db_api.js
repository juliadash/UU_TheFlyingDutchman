...
function populateBeers(){
    var j = 0;
    beers = getAvailBeers();
    var beerString = '<h1>BEERS</h1><div class="row">'
    for (var i=0; i<beers.length; i++){
        ...
        if (b.namn == "" || b.namn2 == "" || b.price == ""){
            ...
            if (j % 3 === 2){
                beerString += '<div class="col-md-4"><div class="card"><div class="card-header"><img src="img/beer.jpg"/></div><div class="card-content"><h3>'+ b.namn + "</h3><h4>" + b.namn2 + "</h4><b>" + b.price + ' SEK</b></div></div></div></div></div><div class="row">';
            } else {
                beerString += '</div><div class="col-md-4"><div class="card"><div class="card-header"> <img src="img/beer.jpg"/></div><div class="card-content"><h3>'+ b.namn + "</h3><h4>" + b.namn2 + "</h4><b>" + b.price + ' SEK</b></div></div></div></div></div>';
            }
        }
        j++;
    }
